...
class BaseBindingRecyclerViewSingleAdapterTestActivity : BaseFssActivity() {
    ...
    override fun initView() {
        ...
        recyclerView.adapter = BaseBindingSingleAdapter<String, LayoutBindingListItemBinding>(
                this,
                ListDataModel.datas,
