...
public class Consts {
    ...
    public static final String WARNING_TIPS = "DO NOT EDIT THIS FILE!!! IT WAS GENERATED BY FssRouter.";
    ...
    // Custom interface
    private static final String FACADE_PACKAGE = "com.gongbo.router";
    ...
    public static final String ANNOTATION_TYPE_ROUTE_API = FACADE_PACKAGE + ".annotation.RouteApi";
}
