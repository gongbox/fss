...
public final class Consts {
    public static final String SDK_NAME = "FssRouter";
    ...
    public static final String FSS_ROUTER_SP_CACHE_KEY = "SP_AROUTER_CACHE";
    public static final String FSS_ROUTER_SP_KEY_MAP = "ROUTER_MAP";
