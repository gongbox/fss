package com.gongbo.fss.router.api.facade;
...
import com.gongbo.fss.router.model.RouteMeta;
...
//    }
    ...
    public Object navigation(Context context, NavigationCallback callback) {
        return FssRouter.getInstance().navigation(context, this, -1, callback);
    }
    ...
    public void navigation(Activity mContext, int requestCode, NavigationCallback callback) {
        FssRouter.getInstance().navigation(mContext, this, requestCode, callback);
    }
...
//        serializationService = FssRouter.getInstance().navigation(SerializationService.class);
